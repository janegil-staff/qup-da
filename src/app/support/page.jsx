...
// Live URL: https://qupda.com/support
//
// Server Component (no "use client"), so `metadata` export works.
// Styling is a plain <style> tag with scoped class names — no styled-jsx,
...
const STYLES = `
  .sa-support {
    ...
    padding: clamp(3rem, 6vw, 6rem) clamp(1.25rem, 5vw, 3rem) clamp(2rem, 4vw, 4rem);
    overflow: hidden;
  }
  ...
  .sa-bg {
    ...
    pointer-events: none;
    background:
      radial-gradient(60% 50% at 85% -5%, rgba(201, 112, 96, 0.1), transparent 70%),
      radial-gradient(50% 45% at 5% 105%, rgba(45, 74, 110, 0.08), transparent 70%);
  }
    ...
    <main className="sa-support">
      ...
      <section className="sa-contact" aria-label="Contact support">
        <div className="sa-contact-card">
          ...
          <a
            className="sa-contact-btn"
            href="mailto:janstovr@gmail.com?subject=Staff%20Arts%20Support"
          >
            janstovr@gmail.com
          </a>
        </div>
      ...
      <footer className="sa-footer">
        <p>
          Staff Arts is made by Qup DA &middot; Organisation no. 912&nbsp;372&nbsp;022 &middot;
          Norway
        </p>
      </footer>
    </main>
